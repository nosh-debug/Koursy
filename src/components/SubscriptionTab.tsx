...
export default function SubscriptionTab({ stats, onUpdateStats, setTab }: SubscriptionTabProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8 space-y-4">
      ...
      <div className="filter blur-md pointer-events-none opacity-50 space-y-8 max-w-4xl mx-auto p-4 md:p-6 font-sans animate-fadeIn">
